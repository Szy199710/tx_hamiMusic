...
<head>
    ...
    <script>
        ...
        function loadMore() {
            ...
            //计算pageSize
            //alert(pageNo);
            var pageSize = 5 * (++pageNo);
            window.location.href = "/songer/dofindAll?tid="+tid+"&isHot="+isHot+"&pageSize="+pageSize+"&pageNo="+pageNo;
        }
    </script>
...
<div id="body" class="gap">
    <input id="tid" type="hidden" value="${songer.tid}">
    <input id="isHot" type="hidden" value="${songer.isHot}">
    <div class="wrapper">
        ...
        <div class="sidebar" data-spm="1392350021">
            <div class="nav">
                ...
                <a class="artists current" href="/songer/dofindAll"><b></b>音乐人</a>
