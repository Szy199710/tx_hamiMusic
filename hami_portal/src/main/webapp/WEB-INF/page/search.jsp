...
<head>
    ...
    <script>
        ...
        function loadMore() {
            ...
            window.location.href = "/song/dofindAll?tid=" + tid + "&isHot=" + isHot + "&isNew=" + isNew + "&pageSize=" + pageSize + "&pageNo=" + pageNo;
        }
...
<div id="body" class="gap">
    <input id="tid" type="hidden" value="${song.tid}">
    <input id="isHot" type="hidden" value="${song.isHot}">
    <input id="isNew" type="hidden" value="${song.isNew}">
    <div class="wrapper">
